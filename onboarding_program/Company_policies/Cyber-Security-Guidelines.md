...
- Common threats involve phishing attacks (fake emails/links to steal your sensitive information), using unsecured networks (using unprotected, public Wifi could lead to data leakage), and unauthorized access (when you leave your devices unattended, someone could look over your data and copy or destroy it)

# What are best practices for keeping your devices and accounts secure?

- Always keep your devices locked when you're away ("Lock" function). Use biometric data, passwords, drawing patterns or their combinations for security.
- Enable automatic locked function after not using the devices.
- Update your software frequently, especially when it contains updates which can fix bugs or strengthen security.
- Don't share passwords to other people, even with acquaintances.  

# Why is it important to lock your computer when away from your desk?

- It helps protect sensitive data from malicious actors or unwanted access.
- When the devices are unlocked, everyone passing by can access the device and view your information, even try to copy or delete it.

# How should you handle phishing attempts and suspicious links?

- Don't click on links from unreliable websites.
- Check for misspellings or mismatches in URLs or email addresses.
- Report to the supervisors and warn other colleagues for awareness.
...
- 2FA prevents unauthorized access from suspicious activities. It requires 2 things: something you know (passwords) and something you have (code/devices).
- You should enable 2FA on work-related accounts, especially accounts that contain sensitive data. Even if your passwords are leaked, 2FA could still block hackers from getting access.
...
- I will apply password managers to secure and encrypt passwords, along with using authenticator app like Google or Microsoft Authenticator to set up 2FA for work and school accounts.
