...
### Here is the link to the article: <https://css-tricks.com/three-buggy-react-code-examples-and-how-to-fix-them/>. My code replicates the first issue, which is the buggy code #1: Mutating state and props
